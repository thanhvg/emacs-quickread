...
Once enabled it will hide the cursor and place a highlight on a certain
character of the current word and then move to the next word in a controllable
speed, it will continue until the end of buffer unless interrupted by start stop
or quit commands. This is expected to guide the reading process.
